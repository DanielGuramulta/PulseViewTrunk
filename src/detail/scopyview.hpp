...
class ScopyView : public ViewBase, public TraceTreeItemOwner, public GlobalSettingsInterface
{
	Q_OBJECT
...
public:
    explicit ScopyView(ScopySession &session, bool is_main_view=false, QWidget *parent = nullptr);
	 ...
	 */
    unordered_set< shared_ptr<ScopySignal> > signals() const;

	virtual void clear_signals();

    void add_signal(const shared_ptr<ScopySignal> signal);
    ...
    shared_ptr<ScopySignal> get_signal_under_mouse_cursor() const;
