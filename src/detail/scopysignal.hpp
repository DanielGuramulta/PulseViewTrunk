...
#ifndef PULSEVIEW_PV_VIEWS_TRACEVIEW_ScopySignal_HPP
#define PULSEVIEW_PV_VIEWS_TRACEVIEW_ScopySignal_HPP
...
namespace data {
class ScopySignalBase;
class ScopySignalData;
}
...
/**
 * The ScopySignal class represents a series of numeric values that can be drawn.
 * This is the main difference to the more generic @ref Trace class.
 *
 * It is generally accepted that ScopySignal instances consider themselves to be
 * individual channels on e.g. an oscilloscope, though it should be kept in
 * mind that virtual ScopySignals (e.g. math) will also be served by the ScopySignal
 * class.
 */
class ScopySignal : public Trace, public ViewItemOwner
{
	Q_OBJECT

protected:
    ScopySignal(pv::ScopySession &session, shared_ptr<data::SignalBase> channel);

public:
	/**
     * Sets the name of the ScopySignal.
	 */
...
#endif // PULSEVIEW_PV_VIEWS_TRACEVIEW_ScopySignal_HPP
