...
#ifndef PULSEVIEW_PV_SCOPYSESSION_HPP
#define PULSEVIEW_PV_SCOPYSESSION_HPP
...
class ScopySession : public QObject
{
	Q_OBJECT
...
public:
    ScopySession(DeviceManager &device_manager, QString name);
...
#endif // PULSEVIEW_PV_SCOPYSESSION_HPP
