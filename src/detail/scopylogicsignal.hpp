...
#ifndef PULSEVIEW_PV_VIEWS_TRACEVIEW_ScopyLogicSignal_HPP
#define PULSEVIEW_PV_VIEWS_TRACEVIEW_ScopyLogicSignal_HPP
...
class ScopyLogicSignal : public ScopySignal
{
	Q_OBJECT
...
public:
    ...
    ScopyLogicSignal(pv::ScopySession &session,
		shared_ptr<devices::Device> device,
		shared_ptr<data::SignalBase> base);

    virtual ~ScopyLogicSignal() = default;
...
#endif // PULSEVIEW_PV_VIEWS_TRACEVIEW_ScopyLogicSignal_HPP
